...
## 从零构建你自己的 &lt;insert-technology-here&gt;

本仓库收录了一系列精心编写的分步指南，教你从零开始重新构建我们喜爱的各种技术。
...
* [内存分配器](#build-your-own-memory-allocator)
...
## 贡献
* 欢迎提交，只需发送一个 PR，或 [创建一个 issue](https://github.com/codecrafters-io/build-your-own-x/issues/new)
* 帮助我们审核 [待处理的提交](https://github.com/codecrafters-io/build-your-own-x/issues)，留下评论和"表情回应"

## 来源与许可证

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

本仓库是[众多贡献者](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors)的共同成果。它由 [Daniel Stefanovic](https://github.com/danistefanovic) 发起，现由 [CodeCrafters, Inc.](https://codecrafters.io) 维护。在法律允许的最大范围内，[CodeCrafters, Inc.](https://codecrafters.io) 已放弃本作品的所有版权及相关或邻接权利。
