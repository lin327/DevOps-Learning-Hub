...
#
#  中文注释版本
#  原始文件: bigquery_generate_query_biggest_tables_across_datasets_by_size.sh
#  所在目录: gcp-GCP云平台
#  说明: 本文件为 bigquery_generate_query_biggest_tables_across_datasets_by_size.sh 的中文注释版本
#
